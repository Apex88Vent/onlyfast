...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  // re-submits while the first Supabase request is still in flight. State
  // updates are async, so a ref gives us an immediate, synchronous lock.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Prevent duplicate submissions (double-click / rapid Enter) from firing a
    // second signUp/login before the first Supabase response returns. This is
    // the main cause of "email rate limit exceeded" during testing.
    ...
    try {
      ...
      // Friendly message for Supabase Auth email rate-limit errors.
